   ...
   extends Sensor< Long >
{
   ...
   private static final Logger logger =
      RioLogger.getLogger( FeederRotation.class.getName() );
    ...
    * @param sensor
    **/
   public FeederRotation( CANTalon encoder )
   {
      super( encoder );
   ...
   public void reset()
   {
      System.out.println( "***** reset() in FeederRotation" );
   }
   ...
   public void update()
   {
      smartDashboard.putNumber( "feederPosition", get() );
   }
